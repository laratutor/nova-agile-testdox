    ...
    ? _c(
        ...
        [
          ...
          _c(
            "card",
            {
              staticClass: "bg-60 flex flex-col",
              ...
              _c(
                ...
                [
                  _vm._l(_vm.data, function(value, key) {
                    return _c("tab", {
                      key: key,
                      attrs: { files: value, tab: _vm.tab, category: key },
                      on: { "select-tab": _vm.selectTab }
                    })
                  }),
                  _vm._v(" "),
                  _c(
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(1)("5c4acbac", content, false, {});
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    data: function data() {
        return {
            activeClass: 'bg-white border border-white text-black font-bold m-2 py-2 px-4 rounded',
            inactiveClass: 'bg-transparent border border-black text-black font-bold m-2 py-2 px-4 rounded'
        };
    }
});
...
var render = function() {
  ...
  return _c("div", [
    _c(
      ...
      {
        class: [
          _vm.category === _vm.tab ? _vm.activeClass : "",
          _vm.inactiveClass
        ],
        attrs: { href: "#" },
        on: {
          click: function($event) {
            _vm.$emit("select-tab", _vm.category)
          }
        }
      },
        ...
        directives: [
          {
            name: "show",
            rawName: "v-show",
            value: _vm.tab === _vm.category,
            expression: "tab === category"
          }
        ],
        staticClass: "m-2"
      },
      _vm._l(_vm.files, function(tests, file_name) {
        return _c("div", [
          _vm._v("\n            " + _vm._s(file_name) + "\n\n            "),
          _c(
            "ul",
            _vm._l(tests, function(test_name) {
              return _c("li", [
                _vm._v(
                  "\n                    " +
                    _vm._s(test_name) +
